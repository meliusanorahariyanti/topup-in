              ...
              <tbody>
                @foreach ($arrays as $item)
                  <tr>
                    ...
                    <td>
                      <form action="/admin/role/{{ $item->id }}" method="POST" onsubmit="return confirm('Apakah anda yakin akan mengahpus data?')">
                        @csrf
                        @method('DELETE')
                        <a href="/admin/role/{{ $item->id }}/edit" class="btn btn-sm btn-info text-white">Ubah</a>
